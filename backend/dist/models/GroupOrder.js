...
const GroupOrderSchema = new mongoose_1.Schema({
...
exports.GroupOrder = mongoose_1.default.models.GroupOrder ||
    mongoose_1.default.model("GroupOrder", GroupOrderSchema);
